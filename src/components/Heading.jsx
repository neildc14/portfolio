...
import { Box, Stack, Text, HStack, Spacer, Button } from "@chakra-ui/react";
import createNewIcon from "../utils/createIcon";
import Account from "./Account";

const Github = createNewIcon(
  "Github",
  "0 0 496 512",
  ...
  return (
    <Box>
      <Stack textAlign="left" lineHeight="shorter">
        <Text as="p" fontSize="xl" textAlign="left" color="gray.300">
          Hello, I am
        </Text>
        <Text
          as="h1"
      ...
      <HStack mt={10}>
        <Button as="a" size="lg" bg="blue.500">
          View Projects
        </Button>
        <Spacer />
        <HStack mt={6}>
